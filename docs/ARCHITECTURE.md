...
The future writer should verify organization/run scope, upsert anomalies by deterministic fingerprint, and translate `evidenceRefs` into `evidence_links` rows from source evidence records to anomaly records. See `docs/ANOMALY_PERSISTENCE.md` for the detailed planning notes.
