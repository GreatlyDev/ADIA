...
- Anomaly persistence planning for a future write phase.
- Server-side anomaly persistence orchestration for already-persisted fixture/parser rows.
- Local parsed-fixture replay support for persisting deterministic anomalies.
- Anomaly dashboard/API read planning for a future dashboard phase.
- No API route or webhook wiring for Terraform or Checkov parser persistence yet.
- No API route, webhook, or dashboard wiring for anomaly persistence yet.
- No LLM calls.
